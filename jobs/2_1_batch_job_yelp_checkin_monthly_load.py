...
spark = SparkSession \
    .builder \
    .appName("2_1_batch_job_yelp_checkin_monthly_load") \
    .getOrCreate()
...
def main():
	...
	"""
	## Check in batch ETL ##
	df_checkin_combined = yetl.import_yelp_monthly_data(spark, 'checkin', '201712', OUTPUT_PATH)
	df_checkin_combined = yetl.transform_checkin_business_split(df_checkin_combined)
	yetl.load_yelp_data_monthly(df_checkin_combined, 'checkin', '201712', 'parquet',  OUTPUT_PATH)
	# yetl.load_yelp_data_monthly(df_checkin_combined, 'checkin', '201712', 'csv',  OUTPUT_PATH)
