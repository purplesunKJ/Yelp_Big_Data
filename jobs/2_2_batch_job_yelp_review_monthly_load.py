...
spark = SparkSession \
    .builder \
    .appName("2_2_batch_job_yelp_review_monthly_load") \
    .getOrCreate()
...
def main():
	...
	"""
	## Check in batch ETL ##
	df_review_combined = yetl.import_yelp_monthly_data(spark, 'review', '201712', OUTPUT_PATH)
	df_review_combined = yetl.transform_review_business_split(df_review_combined)
	yetl.load_yelp_data_monthly(df_review_combined, 'review', '201712', 'parquet',  OUTPUT_PATH)
	# yetl.load_yelp_data_monthly(df_review_combined, 'review', '201712', 'csv',  OUTPUT_PATH)
