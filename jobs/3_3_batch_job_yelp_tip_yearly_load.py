...
spark = SparkSession \
    .builder \
    .appName("3_3_batch_job_yelp_tip_yearly_load") \
    .getOrCreate()
...
def main():
	...
	yetl.load_yelp_data_yearly(df_tip_combined, 'checkin', '2017', 'parquet',  OUTPUT_PATH)
	# yetl.load_yelp_data_yearly(df_tip_combined, 'checkin', '2017', 'csv',  OUTPUT_PATH)
